...
/**
 * LoginForm.tsx — Client component for the sign-in form
 *
 * This component is intentionally separate from login/page.tsx so that
 * useSearchParams() runs inside a <Suspense> boundary (required by Next.js
 * for pages that may be statically prerendered).
 *
 * page.tsx renders the static branding panel + <Suspense><LoginForm /></Suspense>
 * This file owns everything that needs client-side hooks.
 */
    ...
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2 mb-8 lg:hidden">
          ...
          <span className="font-bold text-lg" style={{ color: '#0c1a2e' }}>Vantage</span>
        </div>
        ...
        <div className="rounded-2xl border p-6 shadow-sm space-y-5"
          ...
          <button
            ...
            disabled={!!loading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border
                       text-sm font-semibold transition-all hover:shadow-md disabled:opacity-50"
          ...
          <form onSubmit={handleCredentials} className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl text-sm font-semibold transition-all
                         hover:shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
